...
//    responseMap.put("subscribersGroup", modelSubscribers.getId().getGroupFilter()); // required
  ...
  public ResponseEntity<Map<String, String>> doUpdateList(@RequestBody CreateOrUpdateListRequestPayload requestPayload) {
  ...
  public ResponseEntity<Map<String, String>> doCreateList(@RequestBody CreateOrUpdateListRequestPayload requestPayload) {
